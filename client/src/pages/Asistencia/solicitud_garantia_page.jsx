...
export default function SolicitudGarantiaPage() {
            ...
            <main className="max-w-7xl mx-auto px-4 py-6">
                {!submitted ? (
                    <ServiceForm
                        ...
                        title="Solicitud de Asistencia en Garantía"
                        submitButtonText="Solicitar Asistencia en Garantía"
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
                        ...
                        >
                            Volver a Solicitar una garantía
                        </Button>
                    </div>
                )}
            </main>
